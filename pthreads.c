...
void convolute(Image *srcImage, Image *destImage, Matrix algorithm)
{
    ...
    int step = srcImage->height / thread_count;
...
void *thread_convolute(void *arguments)
{
    ...
    int step = args->srcImage->height / thread_count;
    printf("Rank: %d\n", args->rank);

    for (row = rank * step; row < srcImage->height && row < rank * step + step; row++)
    {
